...
public final class HospitalServiceGrpc {
  ...
  public static final java.lang.String SERVICE_NAME = "proto.HospitalService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<proto.HospitalOuterClass.Empty,
      proto.HospitalOuterClass.AvailableBedsReply> getGetAvailableBedsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "getAvailableBeds",
      requestType = proto.HospitalOuterClass.Empty.class,
      responseType = proto.HospitalOuterClass.AvailableBedsReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<proto.HospitalOuterClass.Empty,
      proto.HospitalOuterClass.AvailableBedsReply> getGetAvailableBedsMethod() {
    io.grpc.MethodDescriptor<proto.HospitalOuterClass.Empty, proto.HospitalOuterClass.AvailableBedsReply> getGetAvailableBedsMethod;
      ...
      synchronized (HospitalServiceGrpc.class) {
        if ((getGetAvailableBedsMethod = HospitalServiceGrpc.getGetAvailableBedsMethod) == null) {
          HospitalServiceGrpc.getGetAvailableBedsMethod = getGetAvailableBedsMethod =
              io.grpc.MethodDescriptor.<proto.HospitalOuterClass.Empty, proto.HospitalOuterClass.AvailableBedsReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "getAvailableBeds"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  proto.HospitalOuterClass.Empty.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  proto.HospitalOuterClass.AvailableBedsReply.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<proto.HospitalOuterClass.Hospital,
      proto.HospitalOuterClass.HospitalsForRegionReply> getGetHospitalsForRegionMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "getHospitalsForRegion",
      requestType = proto.HospitalOuterClass.Hospital.class,
      responseType = proto.HospitalOuterClass.HospitalsForRegionReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<proto.HospitalOuterClass.Hospital,
      proto.HospitalOuterClass.HospitalsForRegionReply> getGetHospitalsForRegionMethod() {
    io.grpc.MethodDescriptor<proto.HospitalOuterClass.Hospital, proto.HospitalOuterClass.HospitalsForRegionReply> getGetHospitalsForRegionMethod;
      ...
      synchronized (HospitalServiceGrpc.class) {
        if ((getGetHospitalsForRegionMethod = HospitalServiceGrpc.getGetHospitalsForRegionMethod) == null) {
          HospitalServiceGrpc.getGetHospitalsForRegionMethod = getGetHospitalsForRegionMethod =
              io.grpc.MethodDescriptor.<proto.HospitalOuterClass.Hospital, proto.HospitalOuterClass.HospitalsForRegionReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  proto.HospitalOuterClass.HospitalsForRegionReply.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void getAvailableBeds(proto.HospitalOuterClass.Empty request,
        io.grpc.stub.StreamObserver<proto.HospitalOuterClass.AvailableBedsReply> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getGetAvailableBedsMethod(), responseObserver);
    }

    /**
     */
    default void getHospitalsForRegion(proto.HospitalOuterClass.Hospital request,
        io.grpc.stub.StreamObserver<proto.HospitalOuterClass.HospitalsForRegionReply> responseObserver) {
  ...
  public static final class HospitalServiceStub
    ...
    /**
     */
    public void getAvailableBeds(proto.HospitalOuterClass.Empty request,
        io.grpc.stub.StreamObserver<proto.HospitalOuterClass.AvailableBedsReply> responseObserver) {
    ...
    /**
     */
    public void getHospitalsForRegion(proto.HospitalOuterClass.Hospital request,
        io.grpc.stub.StreamObserver<proto.HospitalOuterClass.HospitalsForRegionReply> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
  ...
  public static final class HospitalServiceBlockingStub
    ...
    /**
     */
    public proto.HospitalOuterClass.AvailableBedsReply getAvailableBeds(proto.HospitalOuterClass.Empty request) {
    ...
    /**
     */
    public proto.HospitalOuterClass.HospitalsForRegionReply getHospitalsForRegion(proto.HospitalOuterClass.Hospital request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class HospitalServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<proto.HospitalOuterClass.AvailableBedsReply> getAvailableBeds(
        proto.HospitalOuterClass.Empty request) {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<proto.HospitalOuterClass.HospitalsForRegionReply> getHospitalsForRegion(
        proto.HospitalOuterClass.Hospital request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_AVAILABLE_BEDS:
          serviceImpl.getAvailableBeds((proto.HospitalOuterClass.Empty) request,
              (io.grpc.stub.StreamObserver<proto.HospitalOuterClass.AvailableBedsReply>) responseObserver);
          break;
        case METHODID_GET_HOSPITALS_FOR_REGION:
          serviceImpl.getHospitalsForRegion((proto.HospitalOuterClass.Hospital) request,
              (io.grpc.stub.StreamObserver<proto.HospitalOuterClass.HospitalsForRegionReply>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              proto.HospitalOuterClass.Empty,
              proto.HospitalOuterClass.AvailableBedsReply>(
                service, METHODID_GET_AVAILABLE_BEDS)))
        .addMethod(
          getGetHospitalsForRegionMethod(),
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              proto.HospitalOuterClass.Hospital,
              proto.HospitalOuterClass.HospitalsForRegionReply>(
  ...
  private static abstract class HospitalServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return proto.HospitalOuterClass.getDescriptor();
    }
